import { IBuildResult } from "./build-result.js";
import { IBuildTaskOption, IConsoleType } from "./options.js";
import { IASTCQuality, IETCQuality, IPVRQuality, ITextureCompressType } from "./texture-compress.js";
...
export namespace AssetHandlers {
    export type compressTextures = (tasks: { src: string; dest: string; quality: number | IPVRQuality | IASTCQuality | IETCQuality; format: ITextureCompressType }[]) => Promise<void>;
}

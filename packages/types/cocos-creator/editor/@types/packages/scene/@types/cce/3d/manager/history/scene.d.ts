...
import SnapshotCommand from "../../../../../source/script/3d/manager/history/snapshot-command.js";
import UndoManagerBase from "../../../../../source/script/3d/manager/history/undo-manager-base.js";
interface SceneInfo {
    uuid: string;

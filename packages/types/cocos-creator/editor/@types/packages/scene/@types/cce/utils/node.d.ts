import { LightProbeGroup, Mat4, MeshRenderer, Node, Quat, Rect, Size, UITransform, Vec2, Vec3, Vec4, geometry, renderer } from "cc";
export declare class NodeUtils {
    ...
    getRaycastResults(camera: renderer.scene.Camera, x: number, y: number, mask?: number): import("../../../source/script/utils/raycast.js").IRaycastResult[];
    getRaycastResultsForSnap(camera: renderer.scene.Camera, x: number, y: number, mask?: number): import("../../../source/script/utils/raycast.js").IRaycastResult[];

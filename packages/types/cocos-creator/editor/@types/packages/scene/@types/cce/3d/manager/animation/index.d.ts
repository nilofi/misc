...
import { EditorAnimationClipDump, IAniEditInfo, IAniResultBase, IAnimOperation, IChangeNodeOptions, IPropCurveDumpData } from "../../../../../source/private.js";
import { IAnimData } from "../../../../../source/script/3d/manager/animation/type-defines.js";
...
export declare class AnimationManager extends EventEmitter implements ISceneEvents {
    ...
    queryAnimClipsInfo(nodeUuid: string): {
        clipsMenu: import("../../../../../source/private.js").IClipInfo[];
    ...
    computedTime(currentTime: number): number;
    /**
     * 设置当前编辑的关键帧时间点

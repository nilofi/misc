...
import { Camera, Color, Component, IVec3Like, Layers, Light, Material, Mesh, MeshRenderer, ModelComponent, Node, geometry, gfx, math, physics, primitives } from "cc";
import { DynamicMeshPrimitive, IAddMeshToNodeOption, ICreateMeshOption, IMeshPrimitive } from "../../../../../../source/script/public/gizmos/defines.js";
import EngineInterface from "../../../../../../source/script/public/gizmos/utils/engine/engine-interface.js";
...
export declare class Engine3D implements EngineInterface {
    ...
    getBoundingBox(component: Component): import("../../../../../../source/script/utils/aabb.js").default | geometry.AABB | null;

...
import { GeometryRenderer as CCGeometryRenderer, Component, Node } from "cc";
import { IChangeNodeOptions } from "../../../../../source/private.js";
import { GeometryRenderer } from "../../../../../source/script/3d/manager/engine/geometry_renderer.js";
import { ISceneEvents } from "../../../../../source/script/3d/manager/scene-events-interface.js";
import { EventEmitter } from "../../../../../source/script/utils/event-emitter.js";
...
export declare class EngineManager extends EventEmitter implements ISceneEvents {
    ...
    private _sceneTick;
    init(): Promise<void>;
    setTimeout(callback: any, time: number): NodeJS.Timeout;
...
export { NeedAnimState, engineManager };

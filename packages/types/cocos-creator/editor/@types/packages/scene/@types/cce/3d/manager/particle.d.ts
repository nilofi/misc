import { Asset, Component, Node, ParticleSystemComponent } from "cc";
import { IChangeNodeOptions, IOptionBase } from "../../../../source/private.js";
import { SceneModeType } from "../../../../source/script/3d/facade/scene-facade-state-interface.js";
...
export declare class ParticleManager implements ISceneEvents {
    ...
    onSceneAssetChanged?(uuid: string, asset: Asset | null, info?: any, meta?: any): void;

...
import { IAnimationClipData, ICurveInfo, IPropCustomData } from "../../../../../source/script/3d/manager/animation/type-defines.js";
/**
...
declare class EditorAnimationCombinedCurve extends EditorAnimationCurveBase {
    ...
    getDumpData(): Promise<{
        nodePath: string;
        keyframes: import("../../../../../source/private.js").IKeyDumpData[];
        displayName: string;
        key: string;

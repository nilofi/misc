...
import { IOptionBase } from "../../../../../source/private.js";
import { CreateNodeOptions, INode, IProperty } from "../../../../../source/public.js.js.js";
import { ISceneEvents } from "../../../../../source/script/3d/manager/scene-events-interface.js";
import EventEmitter from "../../../../../source/script/public/EventEmitter.js";
/**
 * 节点管理器
 *
 * Events:
...
export declare class NodeManager extends EventEmitter implements ISceneEvents {
     ...
     * @param {String} uuid
     */
    queryDump(uuid: string): INode | import("../../../../../source/public.js.js.js").IScene | null;
    /**
     * 查询一个节点，并返回该节点的 dump 数据
     * 不论节点是否被删除
     * @param {String} uuid
     */
    queryDumpAtAll(uuid: string): INode | import("../../../../../source/public.js.js.js").IScene | null;
    /**
     * 查询当前场景的节点树信息

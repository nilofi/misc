...
import { Color, ISizeLike, Quat, Vec3, renderer } from "cc";
...
import EditorCameraComponent from "../../../../../source/script/3d/manager/camera/editor-camera-components.js";
...
export declare class Camera extends EventEmitter implements ISceneEvents {
    ...
    saveConfig(scene: any): Promise<void>;
    getCurCameraInfo(): {
        position: {
            x: number;
            y: number;

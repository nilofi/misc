import { CreateComponentOptions, CreateNodeOptions, CutNodeOptions, ExecuteComponentMethodOptions, ExecuteSceneScriptMethodOptions, IAniResultBase, IAnimOperation, IComponent, MoveArrayOptions, PasteNodeOptions, QueryClassesOptions, RemoveArrayOptions, RemoveComponentOptions, RemoveNodeOptions, SetPropertyOptions } from "./public.js";

import { Component, Node, Quat, Vec3 } from "cc";
import { ISceneEvents } from "../source/script/3d/manager/scene-events-interface.js";
import { AssetInfo, IAssetMeta, IPropCurveDumpData } from "./private.js";
...
interface ISceneFacade extends ISceneEvents {
     ...
     * 保存一次操作记录
     */
    public snapshot(command?: any): Promise<void>;
    ...
    onSceneAssetChanged(uuid: string, asset: Asset | null, info: AssetInfo, meta: IAssetMeta): Promise<void>;

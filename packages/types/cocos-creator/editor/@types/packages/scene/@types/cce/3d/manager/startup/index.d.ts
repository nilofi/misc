import { IGameConfig, Node } from "cc";
import { EngineInfo } from "../../../../../../engine/@types/index.js";
...
declare global {
    export namespace cce {
        let project: string;
        let SceneFacadeManager: InstanceType<typeof import("../../../../../source/script/3d/facade/scene-facade-manager.js")["SceneFacadeManager"]>;

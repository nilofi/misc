...
import { Asset, Component, Node } from "cc";
import { EventEmitter } from "events";
import { AssetInfo, IAssetMeta, IDragEvent } from "../../../../../../../builtin/scene/@types/private.js";
...
export declare class SceneAssetManager extends EventEmitter implements ISceneEvents {
     ...
     * @returns
     */
    loadAnyWrapper<TAsset extends Asset = Asset>(
        uuid: string,
        options?: {
            option?: any;
     ...
     * @returns
     */
    loadAnyClone<TAsset extends Asset = Asset>(
        uuid: string,
        options?: {
            option?: any;
            onComplete?: (error: Error | null, asset: TAsset) => void;
    ...
    queryMaterial(uuid: string): Promise<{
        ...
        data: {
            ...
            passes: {
                ...
                props: any[];
                defines: any[];
                states: import("../../../../../source/public.js.js.js").IProperty;

...
import { Asset, Constructor, ValueType } from "cc";
import { CCON } from "cc/editor/serialization";
import { IArrayOptions, IBuilder, IBuilderOptions, IClassOptions, ICustomClassOptions, IObjParsingInfo, PropertyOptions } from "../../../../source/editor-extends/utils/serialize/parser.js";
...
export declare function findRootObject(
    data: Format.AnyItem,
    type: string,
):
    | string
